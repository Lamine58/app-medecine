  ...
  void _saveData() async {
    ...
    try {
      ...
      if(photo!=null){
        ...
        response = await api.upload('user-data',photo, {
          "id": id,
      ...
      if (response['status'] == 'success') {
        ...
        Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(
            builder: (context) => DashboardCenter(),
          ),
          (routes)=>false
        );
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            contentPadding: EdgeInsets.only(left:15,top: 15,bottom: 20,right: 15),
                            labelText: translate('label_new_password', lang),
                            labelStyle: TextStyle(color: Color.fromARGB(255, 120, 120, 120),fontWeight: FontWeight.w300),
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(5),
                            ),
                        ...
                        ElevatedButton(
                          ...
                          child: spinner==true ? CircularProgressIndicator(color: const Color.fromARGB(135, 255, 255, 255)) : Container(
                            ...
                            child: Center(
                              child: Text(translate('save', lang),
